...
echo "- Cluster ScalingGroup: $(aws cloudformation list-stack-resources --stack-name=$CLUSTER_NAME | ../lib/jsawk -n 'if (this.ResourceType == "AWS::AutoScaling::AutoScalingGroup") { out(this.PhysicalResourceId);}')"
echo ""
echo "- Master"
