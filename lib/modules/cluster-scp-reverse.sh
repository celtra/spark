...
MODULE_NAME="scp-reverse"
MODULE_DESCRIPTION="Copy files from cluster nodes"

usage() {
    cat <<EOF
Copy file from all AWS stack instances in parallel. If stack, accessKey and secretKey
